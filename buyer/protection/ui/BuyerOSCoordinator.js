(() => {
  ...
  function loadExperienceV137() {
    if (document.querySelector('script[data-buyeros-v137]')) return;

    const script = document.createElement('script');
    script.src = 'buyer/protection/ui/buyeros-experience-v137.js';
    script.defer = true;
    script.dataset.buyerosV137 = 'true';
  ...
  function loadHouseholdFamilyV144() {
    if (
      document.querySelector(
        'script[data-buyeros-household-family-v144]'
      )
    ) {
      return;
    }
  ...
  function loadImportV145() {
    if (
      document.querySelector(
        'script[data-buyeros-import-v145]'
      )
    ) {
      return;
    }
  ...
  function loadImportReviewV147() {
    if (
      document.querySelector(
        'script[data-buyeros-import-review-v147]'
      )
    ) {
      return;
    }
    ...
    script.src =
      'buyer/protection/ui/buyeros-import-review-v147.js';
...
function loadProtectionV153() {
  if (
    document.querySelector(
      'script[data-buyeros-protection-v153]'
    )
  ) {
    return;
  }
  ...
  script.dataset.buyerosProtectionV153 =
    'true';
...
function loadGraphV152() {
  if (
    document.querySelector(
      'script[data-buyeros-graph-v152]'
    )
  ) {
    return;
  }
  ...
  script.dataset.buyerosGraphV152 =
    'true';
...
function loadIntelligenceV148() {
    ...
    const script = document.createElement('script');
    script.src = 'buyer/protection/ui/buyeros-intelligence-v148.js';
    script.defer = true;
    script.dataset.buyerosIntelligenceV148 = 'true';
    document.head.appendChild(script);
  }
