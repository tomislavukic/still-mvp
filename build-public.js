const fs=require('fs'),path=require('path');const BUNDLE=163;
...
const files=['index.html','app.html','company.html','pricing.html','pricing-v114.js','admin.html','admin.js','styles.css',...css,'share-icons.css','og-v85.png',...runtime,'still-os-v133.js','still-os-v133.css','needs-resolution-v134.js','needs-resolution-v134.css','still-market-v135.js','still-market-v135.css','professional-network-v136.js','professional-network-v136.css','buyer-wallet-v96.js',...companyExtra,'admin-notifications-v69.js','privacy.html','terms.html','methodology.html','legal-i18n.js','robots.txt','sitemap.xml'];
...
fs.copyFileSync(path.join(__dirname,'_headers'),path.join(out,'_headers'));fs.writeFileSync(path.join(out,'build.json'),JSON.stringify({app:'Still',productionBundle:BUNDLE,architecture:'still-os-world-needs-resolution-market-professional-network-with-preserved-company-workspace',generatedAt:new Date().toISOString(),runtime,publicRuntime,publicStyles,authenticatedApp:['app.html','still-os-v133.js','still-os-v133.css','needs-resolution-v134.js','needs-resolution-v134.css','still-market-v135.js','still-market-v135.css','professional-network-v136.js','professional-network-v136.css'],companyScripts,companyFeatureScripts,files},null,2)+'\n');console.log(`Built V${BUNDLE}: Still OS with a lightweight public sign-in shell and preserved authenticated capabilities.`);
