const fs=require('fs'),path=require('path');const BUNDLE=164;
...
const companyStyles=['relationship-v61.css','company-branches-v68.css','notifications-v69.css','company-workbench-v72.css','company-services-v73.css','company-service-network-v137.css','company-ops-v74.css','company-rewards-v75.css','company-positioning-v83.css','company-passport-studio-v83.css','company-commerce-v92.css','company-lifecycle-v95.css','company-operations-v96.css','company-control-center-v101.css','relationship-dashboard-v103.css','electronic-shelf-labels-v106.css','site-quality-v82.css','design-system-v84.css','responsive-readability-v85.css','surface-polish-v86.css','refinement-v87.css','visual-details-v90.css','rewards-visible-v91.css','brand-alignment-v104.css','still-v114.css','companyos-v120.css','company-intelligence-v128.css'];
const companyExtra=[...companyScripts,...companyFeatureScripts,...companyStyles];
const files=['index.html','app.html','company.html','pricing.html','pricing-v114.js','admin.html','admin.js','styles.css',...css,'share-icons.css','og-v85.png',...runtime,'still-os-v133.js','still-os-v133.css','needs-resolution-v134.js','needs-resolution-v134.css','still-market-v135.js','still-market-v135.css','professional-network-v136.js','professional-network-v136.css','service-network-v137.js','service-network-v137.css','buyer-wallet-v96.js',...companyExtra,'admin-notifications-v69.js','privacy.html','terms.html','methodology.html','legal-i18n.js','robots.txt','sitemap.xml'];
...
fs.copyFileSync(path.join(__dirname,'_headers'),path.join(out,'_headers'));fs.writeFileSync(path.join(out,'build.json'),JSON.stringify({app:'Still',productionBundle:BUNDLE,architecture:'still-os-world-needs-resolution-market-professional-services-network-with-preserved-company-workspace',generatedAt:new Date().toISOString(),runtime,publicRuntime,publicStyles,authenticatedApp:['app.html','still-os-v133.js','still-os-v133.css','needs-resolution-v134.js','needs-resolution-v134.css','still-market-v135.js','still-market-v135.css','professional-network-v136.js','professional-network-v136.css','service-network-v137.js','service-network-v137.css'],companyScripts,companyFeatureScripts,files},null,2)+'\n');console.log(`Built V${BUNDLE}: Still OS with ownership-native services and preserved authenticated capabilities.`);
